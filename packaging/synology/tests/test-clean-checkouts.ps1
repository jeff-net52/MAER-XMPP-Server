...
function Assert-LfCheckout {
    ...
    $criticalPaths = @(
        ...
        'packaging/synology/tests/path-utils.ps1',
        'packaging/synology/tests/release-gate.ps1',
        'packaging/synology/tests/test-spk-path-resolution.ps1',
        'packaging/synology/tests/validate-source.ps1',
        'packaging/synology/tests/test-installer-contract.sh',
        'packaging/synology/tests/test-installer-recipe-order.sh',
        ...
        'packaging/synology/spksrc-overlay/cross/maerxmppserver/patches/003-maer-user-portal.patch',
        'packaging/synology/spksrc-overlay/cross/maerxmppserver/patches/004-maer-webadmin.patch',
        'packaging/synology/spksrc-overlay/cross/maerxmppserver/patches/005-maer-native-websocket-origin.patch',
        'packaging/synology/tests/test-server-patches.ps1',
        'packaging/synology/spksrc-overlay/spk/maerxmppserver/src/COPYING',
        'packaging/synology/spksrc-overlay/spk/maerxmppserver/src/installer-fail-closed.patch',
